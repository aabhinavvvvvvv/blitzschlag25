  ...
  return (
    <div className="w-full md:px-10" ref={containerRef}>
      <div className="mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h1
          className="text-6xl md:text-7xl mx-auto text-center mb-16 mt-4 font-bold"
          style={{
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
            ...
            <div key={index} className="flex justify-start pt-10 md:pt-20 md:gap-10">
              <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20">
                  <div className="h-4 w-4 rounded-full bg-gradient-to-r from-pink-500 to-cyan-500" />
                </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-b from-pink-500 via-white to-cyan-500"
          />
        </div>
      </div>
    </div>
