...
const FAQ = () => {
            ...
            },
            {
                ...
                content: (
                    <ol>
                        ...
                        <li>2. Navigate to Event for which you  want to create team.</li>
            ...
            },
            {
                ...
                content: (
                    <ol>
                        <li>1. Go to your <a href="profile" className="text-blue-500 hover:text-blue-600 hover:underline">Profile page</a>.</li>
                        <li>2. Look for the <strong>Events</strong> section.</li>
                        <li>3. Look for Event which <strong>Team Code</strong> you want.</li>
                    </ol>
                ),
            },
        ],
    ...
    return (
        <div
            ...
            <div className="max-w-5xl mx-auto p-16 rounded-xl bg-black bg-opacity-45 border-2 border-[rgba(255,255,255,0.3)] mt-20">
                <p
                    style={{ fontFamily: '"Amarante", serif' }}
                    className="text-center mx-auto w-fit text-5xl text-white"
                >
                    FAQ
                </p>
            ...
            <div className="max-w-5xl mx-auto p-16 rounded-xl  bg-black bg-opacity-45 border-2 border-[rgba(255,255,255,0.3)] mt-16">
                <p
                    style={{ fontFamily: '"Amarante", serif' }}
                    className="text-center mx-auto w-fit text-5xl text-white"
                >
                ...
                <form className="space-y-6" onSubmit={onSubmit}>
                    ...
                    <input
                        ...
                        name="email"
                        className="placeholder-white bg-transparent w-full p-3  border-b-2 border-gray-300 outline-none text-white" required />
                    <textarea
                        name="message"
                        placeholder="Your Message"
                        required
                        className="placeholder-white bg-transparent w-full p-3  border-b-2 border-gray-300 outline-none text-white"></textarea>
                    <button
                        type="submit"
