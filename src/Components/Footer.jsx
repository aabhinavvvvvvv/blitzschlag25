    ...
    <div className="bg-gray-900 text-white py-10 mt-16">
      ...
      <div className="container mx-auto px-6 md:px-16 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex justify-center md:justify-start gap-8">
          <img src={mnitlogo} className="w-20 h-20 md:w-24 md:h-24" alt="MNIT Logo" />
          <img src={clublogo} className="w-20 h-20 md:w-24 md:h-24" alt="Cultural Club Logo" />
        </div>

        <div className="text-center md:text-left text-lg">
          <p className="font-semibold text-xl mb-2">Get Support</p>
          <p>Contact Us:</p>
