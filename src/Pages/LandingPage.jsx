      ...
      <ScrollPage>
        <Animator style={{
          ...
          <div className="bg-black text-white py-10">
            ...
            <div className="container mx-auto px-6 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-8 justify-between items-start">
              <Animator animation={MoveIn(0, 1000)}>
                <div className="flex flex-col justify-center items-center">
                  <img src={logo} className="w-40" alt="Blitzschlag Logo"/>
                  <div className="flex justify-center gap-8">
                    <img src={mnitlogo} className="w-24 h-24 md:w-24 md:h-24" alt="MNIT Logo" />
                    <img src={clublogo} className="w-24 h-24 md:w-24 md:h-24" alt="Cultural Club Logo" />
                  </div>
                </div>
              </Animator>
              <Animator className="flex gap-16" animation={MoveIn(0, 1000)}>
              <div className="text-center md:text-left text-lg">
                  <p className="font-semibold text-xl mb-2">Links</p>
                  <p><a href="https://mnit.ac.in/" target="_blank">MNIT</a></p>
                  <p><a href="https://mnit.ac.in/cacs/" target="_blank">CACS</a></p>
                  <p><a href="https://mnit.ac.in/blitzschlag/" target="_blank">Blitzschlag</a></p>
                </div>
                <div className="text-center md:text-left text-lg">
                  <p className="font-semibold text-xl mb-2">Technical Secretary</p>
                  <p>Sachin Agarwal</p>
                  <p>Lokesh Kumar Suthar</p>
                </div>
                <div className="text-center md:text-left text-lg">
                  <p className="font-semibold text-xl mb-2">Credits</p>
                  <p>Anant Hansras</p>
                  <p>Kavyansh Bagdi</p>
            ...
            <Animator className="absolute w-full bottom-0" animation={FadeIn(0,10000)}>
              {/* Divider */}
              <div className="w-full border-t-2 border-gray-600 my-8"></div>
              ...
              <div className="container mx-auto px-6 md:px-16 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="text-center md:text-left text-sm">
                  <p>© Developed by Technical Team (CACS) for BLITZSCHLAG 2025</p>
                </div>

                <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mt-4 sm:mt-0">
                  ...
                  <div className="flex gap-6 items-center">
                    ...
                    <a
                      ...
                      className="text-white hover:text-red-600 transition-all duration-200 transform hover:scale-110"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-white hover:text-pink-500 transition-all duration-200 transform hover:scale-110"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-white hover:text-blue-600 transition-all duration-200 transform hover:scale-110"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path className="fill-current" d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
                      </svg>
                    </a>
                  </div>
                </div>
