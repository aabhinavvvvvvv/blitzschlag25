        ...
        >
          ...
          <Animator animation={MoveIn(-1000, 0)}>
            <div style={{ textAlign: "center", marginBottom: "40px" }}>
              <h2 style={{ fontSize: "32px", fontWeight: "600", marginBottom: "10px" }}>
                Get Support
              </h2>
              <p style={{ fontSize: "18px" }}>
                Contact Us:
                <br />
                <strong>Sachin Agarwal (Technical Secretary)</strong>
                <br />
                <strong>Lokesh Kumar Suthar (Technical Secretary)</strong>
              </p>
            </div>
          </Animator>
          ...
          <Animator animation={MoveIn(1000, 0)}>
            <div style={{ textAlign: "center", marginBottom: "40px" }}>
              <p style={{ fontSize: "18px", marginBottom: "20px" }}>Follow Us:</p>
