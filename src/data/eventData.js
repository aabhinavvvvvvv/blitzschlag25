...
const eventData = {
    ...
    culturaltells: {
        ...
        description: 'Cultural Tells celebrates India’s diverse heritage. Teams represent their states through a presentation on traditions, festivals, and art, followed by a quiz on Indian culture. This event encourages learning about and appreciating the rich cultural tapestry of India.',
        maxTeamSize: 1,
    ...
    totebag:{
        ...
        venue: 'CV RAMAN HALL',
        day: 1,
        rulebook: '/RULEBOOK TOTE BAG.pdf',
        description: '',
        maxTeamSize: 1,
        eventPath: 'captionclash',
        imgUrl:totebag  ,
    ...
    quillingcontest:{
        ...
        venue: 'CV RAMAN HALL',
        day: 1,
        rulebook: '/RULEBOOK QUILLING.pdf',
        description: '',
        maxTeamSize: 1,
    ...
    clayornament:{
        ...
        venue: 'CV RAMAN HALL',
        day: 1,
        rulebook: '/RULEBOOK CLAY ORNAMENTATION.pdf',
        description: '',
        maxTeamSize: 1,
    ...
    cushionpaint:{
        ...
        venue: 'CV RAMAN HALL',
        day: 1,
        rulebook: "/RULEBOOK CUSHION MAKING.pdf",
        description: '',
        maxTeamSize: 1,
    ...
    fairytale:{
        name: 'Fairy Tale Faces',
        venue: 'VLTC L-101',
        day: 2,
        rulebook: "RULEBOOK FAIRYTALE FACES.pdf",
        description: '',
        maxTeamSize: 1,
        eventPath: 'fairytale',
        imgUrl: fairytale ,
    ...
    macraneart:{
        ...
        description: '',
        maxTeamSize: 1,
        eventPath:'macraneart',
        imgUrl: post ,
        club: 'Creative Arts',
        type: 'club',
    },
    interactiveartworkclash:{
        name: 'Interactive Artwork Clash',
        venue: 'VLTC(L-101)',
        day: 2,
        rulebook: '',
        description: '',
        maxTeamSize: 1,
        eventPath: 'interactiveartworkclash',
        imgUrl: post ,
        club: 'Creative Arts',
        type: 'club',
    },
    embroideryartworkshop:{
        name: 'Embroidery art Workshop',
        venue: 'CV RAMAN HALL',
        day: 3,
        rulebook: '',
        description: '',
        maxTeamSize: 1,
        eventPath: 'embroiderydartworkshop',
        imgUrl: post ,
        club: 'Creative Arts',
        type: 'club',
    },
    frameyourvusion:{
        name: 'Frame Your Vision Challenge',
        venue: 'CV RAMAN HALL',
        day: 3,
        rulebook: '',
        description: '',
